...
import {ShareController} from './category.controller';
import {ShareService}    from './category.service';
import {EchoService}     from '../../../../common/service/echo.service';
import {ToolsService}    from '../../../../common/service/tools.service';

describe('CategoryController', () => {

    let categoryController: ShareController;
    ...
    beforeAll(async () => {
        const module = await Test.createTestingModule({
            ...
            providers  : [
                ...
                {provide: 'categoryService', useClass: ShareService},
                {provide: 'echoService', useClass: EchoService}
            ],
        }).compile();

        categoryController = module.get(ShareController);
    });
